...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.skill-category, .project-card, .timeline-item, .about-text, .contact-info, .contact-form');
...
document.querySelectorAll('a[href^="http"]').forEach(link => {
    link.addEventListener('click', function(e) {
        if (this.href === '#') {
            e.preventDefault();
            alert('Ce lien sera bientôt disponible!');
        }
    });
});
...
console.log(`
🚀 Portfolio Otniel Tamini
💻 Développé avec passion
🔧 HTML, CSS, JavaScript
📧 Contact: otniel.tamini@email.com
`);
